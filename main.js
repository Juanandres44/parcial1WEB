...
const tituloMin = document.getElementById('tituloProducto')

const logoCarrito = document.getElementById("carro");
...
function cargarOrden(){
  ...
  tabla.className = 'table-responsive table-striped'
  ...
  carrito.forEach((values,keys) => {
    ...
    b1.className = 'btn plus btn-dark'
    b1.innerText = '+'
    let b2 = document.createElement('a')
    b2.className = 'btn neg btn-dark'
    b2.innerText = '-'
  ...
  abajo.className='container-fluid'
  ...
  botts.className='col botones'
  b1 = document.createElement('a')
  b1.className = 'btn botonesCancelarCompra'
  b1.innerText = 'Cancel'
  b2 = document.createElement('a')
  b2.className = 'btn botonesCompra'
  b2.innerText = 'Confirm order'

  b1.dataset.toggle = 'modal'
  b1.dataset.target = '#alerta'
